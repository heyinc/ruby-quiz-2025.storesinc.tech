...
def load_image(name)
  wasm? ? JS.global[:gameImages][name].to_s : File.read(File.join(File.dirname(__dir__), "images", "#{name}.sixel"))
end
...
class TreasureHunt
  ...
  TREASURE_DIGESTS = %w[
    ...
    48436f8948916c1a330f20c90f0f7b1c5dd8e8b30f2d4ba567d8929cb17f841c
  ]
